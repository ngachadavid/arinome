...
export default function ContactHero() {
  ...
  return (
    <div className="relative">
      ...
      <div className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 bg-white h-screen max-w-7xl rounded-2xl shadow-2xl z-10 flex flex-col-reverse md:flex-row gap-6 p-2 md:p-6 transition-all duration-800 ease-out w-[92%] md:w-[80%] mx-auto ${
