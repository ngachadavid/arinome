    ...
    <section className="relative pb-[200px]">
      ...
      <div className="bg-[#448AFF] h-[70vh] 2xl:h-screen relative">
        <div className="max-w-[1280px] px-4 2xl:px-0 mx-auto flex flex-col md:flex-row md:justify-between h-full text-white">
            ...
            {/* Paragraph - positioned right below heading on mobile */}
            <h2
        ...
        {/* Contact Section (Map + Form) - Using percentage-based positioning */}
        <div
          className={`absolute bottom-0 left-1/2 -translate-x-1/2 transform translate-y-1/2 w-[90%] md:w-[80%] z-10 bg-white rounded-2xl shadow-lg flex flex-col-reverse md:flex-row gap-6 transition-all duration-800 ease-out ${
            mounted ? 'translate-y-1/2 opacity-100' : 'translate-y-1/2 opacity-0'
          }`}
