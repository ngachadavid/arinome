...
export default function Navigation() {
    ...
    return (
        <>
            <nav
                className={`fixed w-full z-50 backdrop-blur-md text-[#448AFF] transition-colors duration-300 ${isScrolled ? 'bg-white text-[#448AFF] shadow-md' : 'bg-transparent text-white'
                    }`}
            >
                <div className="max-w-[1280px] px-4 2xl:px-0 mx-auto flex items-center justify-between transition-all duration-300 py-4">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <Link
                            href="/contact"
                            className={`relative group px-4 py-2 rounded-[20px] transition flex items-center space-x-2 overflow-hidden
    ${isScrolled
                                    ? "bg-[#448AFF] text-white hover:bg-transparent hover:text-[#448AFF]"
                                    : "bg-white text-[#448AFF] hover:bg-[#448AFF] hover:text-white"
                                }`}
                        >
                            {/* Text */}
                            ...
                            <div className="relative z-10 w-6 h-6 flex items-center justify-center">
                                <svg
                                    className={`w-6 h-6 transition-transform duration-300 -rotate-45 group-hover:rotate-0 
        ${isScrolled ? "text-white group-hover:text-[#448AFF]" : "text-[#448AFF] group-hover:text-white"}`}
