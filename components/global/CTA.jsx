        ...
        <div ref={ref}>
            <Link href="/contact">
                <div className="group flex items-center justify-between max-w-[1280px] px-4 2xl:px-0 mx-auto w-full text-[#448AFF] bg-white py-10 cursor-pointer">
                    ...
                    {/* Text (left) */}
                    <h2 className={`text-[28px] md:text-[40px] 2xl:text-[80px] font-bold leading-1 transition-all duration-700 ease-out ${
                    ...
                    {/* Arrow (right) */}
                    <div className={`transform -rotate-45 transition-all duration-700 ease-out group-hover:rotate-0 ${
                        isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                    }`}
